...
<section className="   flex items-center gap-12 my-7 lg:my-0">
  ...
  <img src={firstSection} alt=""  className='w-full opacity-35 ' />
    <div className="icons absolute top-0 lg:end-[250px] end-[100px] flex flex-col gap-4 mt-5 lg:text-2xl text-MainColor">
    ...
    <div className="floatedImgs absolute w-1/3 mt-5 flex lg:top-3/4 -bottom-5 start-3 lg:start-1/2 rounded-lg gap-5">
  ...
  <div className="howText font-extrabold text-white uppercase  mb-20 text-end">
    <h2 className='lg:text-9xl md:text-7xl text-4xl me-6 w-3/4'>How we work</h2>
  </div>
</section>
